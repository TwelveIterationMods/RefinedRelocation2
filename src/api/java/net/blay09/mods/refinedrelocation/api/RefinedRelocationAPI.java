...
public class RefinedRelocationAPI {
    ...
    @OnlyIn(Dist.CLIENT)
    public static Button createOpenFilterButton(ContainerScreen<?> guiContainer, TileEntity tileEntity, int rootFilterIndex) {
        return internalMethods.createOpenFilterButton(guiContainer, tileEntity, rootFilterIndex);
    }
